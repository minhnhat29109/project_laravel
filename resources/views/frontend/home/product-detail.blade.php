                    ...
                    <div class="col-md-6">
                        <div class="product-body">
                            ...
                            <h3 class="product-price">{{number_format($product->sale_price)}}VNĐ<del class="product-old-price">
                                    {{ number_format($product->origin_price) }}VNĐ</del></h3>
                            <div>
                            ...
                            <div class="product-btns">
                                ...
                                <a href="{{route('frontend.cart.add', $product->id)}}"><button class="primary-btn add-to-cart"><i class="fa fa-shopping-cart"></i> Thêm vào giỏ hàng</button></a>
