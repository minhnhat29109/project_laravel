                                ...
                                <div class="row hidden-sm hidden-xs">
                                    <div class="col-md-12">
                                        ...
                                        <a class="banner banner-1" href="#">
                                            <img src="/frontend/img/banner05.jpg" alt="">
                                ...
                                <div class="row">
                                    ...
                                    <div class="col-md-4 hidden-sm hidden-xs">
                                        <a class="banner banner-2" href="#">
                                            <img src="/frontend/img/banner04.jpg" alt="">
                                ...
                                <div class="row">
                                    <div class="col-md-3">
                                        <div class="hidden-sm hidden-xs">
                                            <a class="banner banner-1" href="#">
                                                <img src="/frontend/img/banner06.jpg" alt="">
                                                <div class="banner-caption text-center">
                                    ...
                                    <div class="col-md-3">
                                        <div class="hidden-sm hidden-xs">
                                            <a class="banner banner-1" href="#">
                                                <img src="/frontend/img/banner07.jpg" alt="">
                                                <div class="banner-caption text-center">
                                    ...
                                    <div class="col-md-3">
                                        <div class="hidden-sm hidden-xs">
                                            <a class="banner banner-1" href="#">
                                                <img src="/frontend/img/banner08.jpg" alt="">
                                                <div class="banner-caption text-center">
                                    ...
                                    <div class="col-md-3">
                                        <div class="hidden-sm hidden-xs">
                                            <a class="banner banner-1" href="#">
                                                <img src="/frontend/img/banner09.jpg" alt="">
                                                <div class="banner-caption text-center">
                ...
                <div class="product product-details clearfix">
                    ...
                    <div class="col-md-6">
                        <div class="product-body">
                            ...
                            <h3 class="product-price">{{ $product->sale_price }}VNĐ<del class="product-old-price">
                                    {{ $product->origin_price }}VNĐ</del></h3>
                            <div>
